...
from core.reading_list import (
    get_reading_list_by_user_email, 
    get_reading_list_book_by_book_id,
    get_reading_list_by_status, 
    create_reading_list_book, 
    update_reading_list_book, 
    delete_reading_list_book
)
...
class ReadingListService():
    ...
    def fetch_reading_list_by_status(
            self, 
            user_email: str, 
            status: str, 
            db: Session
    ...
    def fetch_reading_list_book_for_user(
            self,
            user_email: str,
            book_id: int,
            db: Session
    ...
    def create_reading_list_book_for_user(
            self,
            user_email: str,
            book_id: int,
            status: str,
    ...
    def update_reading_list_book_for_user(
            self,
            user_email: str,
            book_id: int,
            status: str,
    ...
    def delete_reading_list_book_for_user(
            self,
            user_email: str,
            book_id: int,
            db: Session
